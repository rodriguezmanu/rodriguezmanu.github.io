(function() {
    ...
    function tagsGenerator() {
        var skillsJavascript = ['Javascript', 'AngularJs', 'AngularJs 2', 'Express', 'Nodejs', 'Karma', 'jquery', 'Grunt', 'Gulp', 'Sinon', 'Chai', 'Mocha', 'Jasmine', 'Protractor', 'Chrome Extensions', 'Ionic 1', 'Ionic 2', 'Typescript'],
